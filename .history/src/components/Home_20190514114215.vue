  ...
  <div id="app">
    <el-container class="menu">
      ...
      <el-container>
        <el-aside>
          <el-row class="tac">
            <el-menu :default-active="$route.path" class="el-menu-vertical-demo" unique-opened router @open="handleOpen"
              @close="handleClose" :collapse="isCollapse"  :class="{'ts':isCollapse!=true}">
